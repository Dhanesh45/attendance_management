...
const Attendance = ({updateList}) => {
  const [list, setList] = React.useState([
    ...
    {sno:9,regno:111723203009,name:"Arul Jothie",status:""},
    ...
    {sno:28,regno:111723203028,name:"Gnanesh",status:""},
                    ...
                    list.map((student)=>{
                        return(
                            <tr>
                                ...
                                <td>{student.regno}</td >
                                <td>{student.name}</td>
                                <td><button onClick={()=>markAttendance(student.regno,"PRESENT")}>PRESENT</button></td>
                                <td><button onClick={()=>markAttendance(student.regno,"ABSENT")}>ABSENT</button></td>
                            </tr>
                        )
                    })
                }
